...
public class Column implements java.io.Serializable, Cloneable {
     ...
     * @param remarks
     */
    public Column(Table table, int sqlType, String sqlTypeName, String columnName, int size,
    ...
    public Column(Column c) {
        this(c.getTable(), c.getSqlType(), c.getSqlTypeName(), c.getColumnName(), c.getSize(),
                c.getDecimalDigits(), c.isPk(), c.isNullable(), c.isIndexed(), c.isUnique(),
                c.getDefaultValue(), c.getRemarks());
    }
    ...
    public String getJavaTypeObject() {
        return DbDataTypesUtils.getPreferredJavaTypeObject(getSqlType(), getSize(),
                getDecimalDigits());
    }
